...
public enum Number {
	 ...
	 * @is：整数的数据长度
	 * **/
	public String ch(String msg, int... is) {
		if (digits.value.equals(this.value)) {
			return AnnotationUtil.changeInt(this.value, msg, is);
		}
		else {
			return AnnotationUtil.changeIntNumber(this.value, msg, is);
		}
	}
