...
public enum Order {
	...
	jsonStart,
	//
	sqlFieldRaw, sqlFieldValue, sqlFieldNameValue, tableName,;

	public static boolean checkNeed(String columnName) {
		if ("id".equals(columnName.toLowerCase())) {
			return false;
		}
		if ("create_time".equals(columnName.toLowerCase())) {
			return false;
		}
		if ("update_time".equals(columnName.toLowerCase())) {
			return false;
		}
		return true;
	}
	...
	public static boolean checkNeedUpdateValue(String columnName) {
		if ("update_time".equals(columnName.toLowerCase())) {
			return true;
		}
		return false;
