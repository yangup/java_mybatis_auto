...
public class ServiceCreate {
	...
	public ServiceCreate(Table table) {
		try {
			...
			if (Constant.isTable) {
				fileName = Constant.path + modelName.toLowerCase() + File.separator + modelName + "Service.java";
			} else {
				fileName = Constant.path + Constant.package_ser + File.separator + modelName + "Service.java";
			}
